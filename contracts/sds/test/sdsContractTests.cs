...
namespace sdsTests
{
    ...
    public class sdsContractTests : IClassFixture<CheckpointFixture<sdsContractTests>>
    {
        readonly CheckpointFixture fixture;
        readonly ExpressChain chain;

        public sdsContractTests(CheckpointFixture<sdsContractTests> fixture)
        {
            this.fixture = fixture;
            this.chain = fixture.FindChain("sdsTests.neo-express");
        }
        ...
        public void contract_owner_in_storage()
        {
            ...
            var storages = snapshot.GetContractStorages<sdsContract>();
        ...
        public void can_change_number()
        {
            ...
            engine.ExecuteScript<sdsContract>(c => c.changeNumber(42));
            ...
            var storages = snapshot.GetContractStorages<sdsContract>();
            var contractStorage = storages.StorageMap("sdsContract");
