...
namespace Contract3Tests
{
    [CheckpointPath("test/bin/checkpoints/contract-deployed.neoxp-checkpoint")]
    public class Contract3ContractTests : IClassFixture<CheckpointFixture<Contract3ContractTests>>
    {
        readonly CheckpointFixture fixture;
        readonly ExpressChain chain;

        public Contract3ContractTests(CheckpointFixture<Contract3ContractTests> fixture)
        {
            this.fixture = fixture;
            this.chain = fixture.FindChain("Contract3Tests.neo-express");
        }
        ...
        public void contract_owner_in_storage()
        {
            ...
            var storages = snapshot.GetContractStorages<Contract3Contract>();
        ...
        public void can_change_number()
        {
            ...
            engine.ExecuteScript<Contract3Contract>(c => c.changeNumber(42));
            ...
            var storages = snapshot.GetContractStorages<Contract3Contract>();
            var contractStorage = storages.StorageMap("Contract3Contract");
