...
namespace Contract1
{
    ...
    public class Contract1Contract : SmartContract
    {
        private static StorageMap ContractStorage => new StorageMap(Storage.CurrentContext, "Contract1Contract");
        ...
        {
            ContractStorage.Put('hello','world')
        }
    }
}
