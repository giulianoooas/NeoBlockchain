...
namespace Contract1Tests
{
    [CheckpointPath("test/bin/checkpoints/contract-deployed.neoxp-checkpoint")]
    public class Contract1ContractTests : IClassFixture<CheckpointFixture<Contract1ContractTests>>
    {
        readonly CheckpointFixture fixture;
        readonly ExpressChain chain;

        public Contract1ContractTests(CheckpointFixture<Contract1ContractTests> fixture)
        {
            this.fixture = fixture;
            this.chain = fixture.FindChain("Contract1Tests.neo-express");
        }
        ...
        public void contract_owner_in_storage()
        {
            ...
            var storages = snapshot.GetContractStorages<Contract1Contract>();
        ...
        public void can_change_number()
        {
            ...
            engine.ExecuteScript<Contract1Contract>(c => c.changeNumber(42));
            ...
            var storages = snapshot.GetContractStorages<Contract1Contract>();
            var contractStorage = storages.StorageMap("Contract1Contract");
