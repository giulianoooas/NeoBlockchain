...
namespace Contract2
{
    [DisplayName("YourName.Contract2Contract")]
    [ManifestExtra("Author", "Your name")]
    [ManifestExtra("Email", "your@address.invalid")]
    [ManifestExtra("Description", "Describe")]
    public class Contract2Contract : SmartContract
    {
        private static StorageMap ContractStorage => new StorageMap(Storage.CurrentContext, "Contract2Contract");
