...
namespace SmartContract_
{
    [DisplayName("YourName.SmartContract_Contract")]
    [ManifestExtra("Author", "Your name")]
    [ManifestExtra("Email", "your@address.invalid")]
    [ManifestExtra("Description", "Describe your contract...")]
    public class SmartContract_Contract : SmartContract
    {
        private static StorageMap ContractStorage => new StorageMap(Storage.CurrentContext, "SmartContract_Contract");
