...
namespace test3Tests
{
    ...
    public class test3ContractTests : IClassFixture<CheckpointFixture<test3ContractTests>>
    {
        readonly CheckpointFixture fixture;
        readonly ExpressChain chain;

        public test3ContractTests(CheckpointFixture<test3ContractTests> fixture)
        {
            this.fixture = fixture;
            this.chain = fixture.FindChain("test3Tests.neo-express");
        }
        ...
        public void contract_owner_in_storage()
        {
            ...
            var storages = snapshot.GetContractStorages<test3Contract>();
        ...
        public void can_change_number()
        {
            ...
            engine.ExecuteScript<test3Contract>(c => c.changeNumber(42));
            ...
            var storages = snapshot.GetContractStorages<test3Contract>();
            var contractStorage = storages.StorageMap("test3Contract");
