...
namespace ContractForPresentingTests
{
    [CheckpointPath("test/bin/checkpoints/contract-deployed.neoxp-checkpoint")]
    public class ContractForPresentingContractTests : IClassFixture<CheckpointFixture<ContractForPresentingContractTests>>
    {
        readonly CheckpointFixture fixture;
        readonly ExpressChain chain;

        public ContractForPresentingContractTests(CheckpointFixture<ContractForPresentingContractTests> fixture)
        {
            this.fixture = fixture;
            this.chain = fixture.FindChain("ContractForPresentingTests.neo-express");
        }
        ...
        public void contract_owner_in_storage()
        {
            ...
            var storages = snapshot.GetContractStorages<ContractForPresentingContract>();
        ...
        public void can_change_number()
        {
            ...
            engine.ExecuteScript<ContractForPresentingContract>(c => c.changeNumber(42));
            ...
            var storages = snapshot.GetContractStorages<ContractForPresentingContract>();
            var contractStorage = storages.StorageMap("ContractForPresentingContract");
