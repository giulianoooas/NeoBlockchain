...
namespace vTests
{
    ...
    public class vContractTests : IClassFixture<CheckpointFixture<vContractTests>>
    {
        readonly CheckpointFixture fixture;
        readonly ExpressChain chain;

        public vContractTests(CheckpointFixture<vContractTests> fixture)
        {
            this.fixture = fixture;
            this.chain = fixture.FindChain("vTests.neo-express");
        }
        ...
        public void contract_owner_in_storage()
        {
            ...
            var storages = snapshot.GetContractStorages<vContract>();
        ...
        public void can_change_number()
        {
            ...
            engine.ExecuteScript<vContract>(c => c.changeNumber(42));
            ...
            var storages = snapshot.GetContractStorages<vContract>();
            var contractStorage = storages.StorageMap("vContract");
